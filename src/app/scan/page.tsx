...
import { ConsumptionCard } from '@/components/scan/ConsumptionCard'
...
export default function ScanPage() {
  ...
  const { scanBarcode, loading, error, product, analysis, setProduct, setAnalysis, consumptionStatus, markConsumption } = useScan()
  const { user } = useAuth()
      ...
      {activeProduct && activeAnalysis && !loading && (
        <div className="space-y-3">
          ...
          <ConsumptionCard
            ...
            productName={activeProduct.product_name || 'this product'}
            onMark={markConsumption}
          />
